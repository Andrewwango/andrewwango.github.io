...
1. Current analysis uses public recorded GPS data from 2013 - I can't find any newer dumps than this.
2. All analysed paths are limited to paths which appear on the OSM network. 
3. Anonymised data means it's harder to track how and when the public are using the paths.